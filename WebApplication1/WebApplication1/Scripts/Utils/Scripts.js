...
$(document).ready(function () {
    ...
    $.each(data, function (key, value) {
        $("#SelectDoPadawan").append("<option>" + value.cep + "</option>");
    });
    //adicionamento da função click do botão
    $('#Button1').click(function () {

    });

    $('#SelectDoPadawan').change(function () {
        var ValorSelecionado = this.value;

        //Varro a lista de valores e checo se o cep que o cara selecionou está na lista. =)
        $.each(data, function (key, value) {
            if (value.cep === ValorSelecionado) {
